# Generated by Powerlevel10k configuration wizard on 2025-03-17 at 00:07 CST.
...
# typeset -g POWERLEVEL9K_DIR_TRUNCATE_BEFORE_MARKER=true
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=223
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=228
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=187
...
#   typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='\uf040 '
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}$(print -P "\u2714+")${VCS_STATUS_NUM_STAGED}"
    # !42 if have unstaged changes.
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}$(print -P "\uf040+")${VCS_STATUS_NUM_UNSTAGED}"
